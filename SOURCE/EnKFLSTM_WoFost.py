...
class EnKFLSTM_WoFost():
    ...
    def __initializeEnsemble(self):
        ...
        for i in range(self.__ensemble_size):
            ...
            if self.__override_parameters == None:
                Warning("[EnKFLSTM_WoFost] No override parameters given.")
            else:
    ...
    def batchAssimilate(self, observations, models):
        ...
        for obs in observations:
            self.assimilate(obs)
        print("[EnKFLSTM_WoFost] {} observations assimilated".format(len(observations)))
    ...
    def assimilate(self, obs_data):
        ...
        print("[EnKFLSTM_WoFost] Assimilating data for {} on day {} ".format(str(obs), date))
